        ...
        var bool = false;
         ...
         var
          ...
          setup: function(e)
          {
            ...
            if(opt.balastop==1000)
            {
             $('#zoom').html('<img class="product_rotate_buttons product_rotate_horizontal_interact_buttons" href="javascript:void(0)" src="images/l.png" id="product_rotate_leftframe"><img class="product_rotate_buttons product_rotate_horizontal_interact_buttons" href="javascript:void(0)" src="images/r.png" id="product_rotate_rightframe"><img class="product_rotate_buttons product_rotate_autoplay_buttons" href="javascript:void(0)" src="images/c.png" id="product_rotate_antirotate"><img class="product_rotate_buttons product_rotate_autoplay_buttons" href="javascript:void(0)" src="images/p.png" id="product_rotate_pause"><img class="product_rotate_buttons product_rotate_autoplay_buttons" href="javascript:void(0)" src="images/a.png" id="product_rotate_rotate">');              
            }
            else
            {
             $('#zoom').html('<img class="product_rotate_buttons product_rotate_zoom_buttons" href="javascript:void(0)" src="images/+.png" id="product_rotate_zoomin"><img class="product_rotate_buttons product_rotate_zoom_buttons" href="javascript:void(0)" src="images/-.png" id="product_rotate_zoomout"><img class="product_rotate_buttons product_rotate_horizontal_interact_buttons" href="javascript:void(0)" src="images/l.png" id="product_rotate_leftframe"><img class="product_rotate_buttons product_rotate_horizontal_interact_buttons" href="javascript:void(0)" src="images/r.png" id="product_rotate_rightframe"><img class="product_rotate_buttons product_rotate_autoplay_buttons" href="javascript:void(0)" src="images/c.png" id="product_rotate_antirotate"><img class="product_rotate_buttons product_rotate_autoplay_buttons" href="javascript:void(0)" src="images/p.png" id="product_rotate_pause"><img class="product_rotate_buttons product_rotate_autoplay_buttons" href="javascript:void(0)" src="images/a.png" id="product_rotate_rotate">');               
            }
            //function created by CG
