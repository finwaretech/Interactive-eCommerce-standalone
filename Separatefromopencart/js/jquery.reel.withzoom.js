 ...
 *
 * @license Copyright (c) 2009-2013 Petr Vostrel (https://petr.vostrel.cz/)
 * Dual licensed under the MIT (MIT-LICENSE.txt)
 * and GPL (GPL-LICENSE.txt) licenses.
 *
 * jQuery Reel
 * https://jquery.vostrel.cz/reel
 * Version: 1.2.1
 * Updated: 2013-02-23
 *
 ...
 * CDN
 * ---
 * - https://code.vostrel.cz/jquery.reel-bundle.js (recommended)
 * - https://code.vostrel.cz/jquery.reel.js
 * - https://code.vostrel.cz/jquery.reel-debug.js
 * - or https://code.vostrel.cz/jquery.reel-edge.js if you feel like it ;)
 *
 * Optional Plugins
 * ----------------
 * - jQuery.mouseWheel [B] (Brandon Aaron, https://plugins.jquery.com/project/mousewheel)
 * - or jQuery.event.special.wheel (Three Dub Media, https://blog.threedubmedia.com/2008/08/eventspecialwheel.html)
 *
...
jQuery.reel || (function($, window, document, undefined){
  ...
  var
    reel= $.reel= {
      ...
      def: {
        ...
        // created by CG for cross images (one set horizontal and one set vertical)
        cross:              false,
        // ---
        // ### Basic Definition ######
        //
        ...
        // (learn more in [FAQ](httpss://github.com/pisi/Reel/wiki/FAQ)).
        //
        ...
        // ### Sequence ######
        //
        // Collection of individual frame images is called _Sequence_ and it this way one https request per
    ...
    balastop: 0,
    timerr: 0,
    product_howler_audio_url_reel: '',
    product_howler_audio_loop_reel: true,
        ...
        //
        // [1]:httpss://github.com/pisi/Reel/wiki/Annotations
        //
        ...
        //
        // [1]:httpss://github.com/pisi/Reel/wiki/Deprecations
        //
        ...
        var bool = false;
         ...
         var
          ...
          var
            ...
            var audio_url = opt.product_howler_audio_url_reel;
            // var audio_loop = opt.product_howler_audio_loop_reel;
            
            var howler_audio = new Howl({
                urls: [audio_url],
                loop: [opt.product_howler_audio_loop_reel],
                onend: function() {
                    // alert('Finished!');
          ...
          setup: function(e)
          {
            ...
            //Start - Zoom Functionality Code - Bala
   
            //--> FBZoom Zoom Function
            if (opt.zoomimages[0] !== '' && typeof(opt.zoomimages[0]) !== 'undefined') 
            { 
                t.parent().css({width: opt.imagewidth, height: opt.imageheight, overflow:'hidden', newWidth: opt.imagewidth});
                t.parent().wrap('<div class="fb3dwrap" style="overflow:hidden;" />').css({ width:opt.imagewidth});
                //t.parent().wrap('<div class="fb3dwrap" style="overflow:hidden; height:499px;" />').css({ width:opt.imagewidth});
                ...
                $slider.slider({
                    ...
                    { 
                        ...
                        //This value of variable "val" is accessed/changed each time the zoom functionality is enabled either by clicking on the plus/minus button or using mousewheel.
                        val = ui.value;
                        //alert(val);
                        
                        //Start - Here we are setting new values of width, height, left position and top position of element(i.e., the current image) according to the mousewheel zoom.
                        ...
                        //End - Here we are setting new values of width, height, left position, top position of element(i.e., the current image) according to the mousewheel zoom.
                    }

                });
                //End - Zoom Slider 

                if(opt.balastop!=1000)
                {
                    //Start - Mousewheel to zoom image.
                    if(typeof(jQuery.event.special.mousewheel) !== 'undefined') 
                    {
                        ...
                        // alert("pause");
                         $('#product_rotate_image').trigger("pause");
                            if (delta > 0) 
                            {
                                valore = parseInt($slider.slider('value'), 10) + 12.5;
                    ...
                    //End - Mousewheel to zoom image.   
                }
            }
            
            //End - Zoom Functionality Code - Bala
            
            //function created by CG
            //$('#zoom').html('<img class="product_rotate_buttons product_rotate_zoom_buttons" href="javascript:void(0)" src="https://www.3dwebcommerce.com/3DShop/image/reel/+.png" id="product_rotate_zoomin"><img class="product_rotate_buttons product_rotate_zoom_buttons" href="javascript:void(0)" src="https://www.3dwebcommerce.com/3DShop/image/reel/-.png" id="product_rotate_zoomout"><img class="product_rotate_buttons product_rotate_horizontal_interact_buttons" href="javascript:void(0)" src="https://www.3dwebcommerce.com/3DShop/image/reel/l.png" id="product_rotate_leftframe"><img class="product_rotate_buttons product_rotate_horizontal_interact_buttons" href="javascript:void(0)" src="https://www.3dwebcommerce.com/3DShop/image/reel/r.png" id="product_rotate_rightframe"><img class="product_rotate_buttons product_rotate_vertical_interact_buttons" href="javascript:void(0)" src="https://www.3dwebcommerce.com/3DShop/image/reel/u.png" id="product_rotate_upframe"><img class="product_rotate_buttons product_rotate_vertical_interact_buttons" href="javascript:void(0)" src="https://www.3dwebcommerce.com/3DShop/image/reel/d.png" id="product_rotate_downframe"><img class="product_rotate_buttons product_rotate_autoplay_buttons" href="javascript:void(0)" src="https://www.3dwebcommerce.com/3DShop/image/reel/c.png" id="product_rotate_antirotate"><img class="product_rotate_buttons product_rotate_autoplay_buttons" href="javascript:void(0)" src="https://www.3dwebcommerce.com/3DShop/image/reel/p.png" id="product_rotate_pause"><img class="product_rotate_buttons product_rotate_autoplay_buttons" href="javascript:void(0)" src="https://www.3dwebcommerce.com/3DShop/image/reel/a.png" id="product_rotate_rotate">');
            //$('#zoom').html('<img class="product_rotate_buttons product_rotate_zoom_buttons" href="javascript:void(0)" src="https://www.3dwebcommerce.com/3DShop/image/reel/+.png" id="product_rotate_zoomin"><img class="product_rotate_buttons product_rotate_zoom_buttons" href="javascript:void(0)" src="https://www.3dwebcommerce.com/3DShop/image/reel/-.png" id="product_rotate_zoomout"><img class="product_rotate_buttons product_rotate_horizontal_interact_buttons" href="javascript:void(0)" src="https://www.3dwebcommerce.com/3DShop/image/reel/l.png" id="product_rotate_leftframe"><img class="product_rotate_buttons product_rotate_horizontal_interact_buttons" href="javascript:void(0)" src="https://www.3dwebcommerce.com/3DShop/image/reel/r.png" id="product_rotate_rightframe"><img class="product_rotate_buttons product_rotate_autoplay_buttons" href="javascript:void(0)" src="https://www.3dwebcommerce.com/3DShop/image/reel/c.png" id="product_rotate_antirotate"><img class="product_rotate_buttons product_rotate_autoplay_buttons" href="javascript:void(0)" src="https://www.3dwebcommerce.com/3DShop/image/reel/p.png" id="product_rotate_pause"><img class="product_rotate_buttons product_rotate_autoplay_buttons" href="javascript:void(0)" src="https://www.3dwebcommerce.com/3DShop/image/reel/a.png" id="product_rotate_rotate">');              
            if(opt.balastop==1000)
            {
                //without zoom button

             $('#zoom').html('<img id="buttons_view_enlarged1" class="product_rotate_buttons product_rotate_horizontal_interact_buttons" width="4%" href="javascript:void(0)" src="images/l.png" id="product_rotate_leftframe"><img class="product_rotate_buttons product_rotate_horizontal_interact_buttons buttons_view_enlarged"width="4%" href="javascript:void(0)"  src="images/r.png" id="product_rotate_rightframe"><img class="product_rotate_buttons product_rotate_autoplay_buttons buttons_view_enlarged" width="4%" href="javascript:void(0)"  src="images/c.png" id="product_rotate_antirotate"><img class="product_rotate_buttons product_rotate_autoplay_buttons buttons_view_enlarged" width="4%" href="javascript:void(0)" src="images/p.png" id="product_rotate_pause"><img class="product_rotate_buttons product_rotate_autoplay_buttons " width="4%" href="javascript:void(0)"  src="images/a.png" id="product_rotate_rotate">');              
            }
            else
            {
                //with zoom buttom
             $('#zoom').html('<img class="product_rotate_buttons buttons_view_minimised product_rotate_zoom_buttons" width="4%" padding="0px" href="javascript:void(0)" src="images/+.png" id="product_rotate_zoomin"><img class="product_rotate_buttons buttons_view_minimised product_rotate_zoom_buttons" width="4%" padding="0px" href="javascript:void(0)" src="images/-.png" id="product_rotate_zoomout"><img class="product_rotate_buttons buttons_view_minimised product_rotate_horizontal_interact_buttons" width="4%" padding="0px" href="javascript:void(0)" src="images/l.png" id="product_rotate_leftframe"><img class="product_rotate_buttons buttons_view_minimised product_rotate_horizontal_interact_buttons" width="4%" padding="0px" href="javascript:void(0)" src="images/r.png" id="product_rotate_rightframe"><img class="product_rotate_buttons buttons_view_minimised product_rotate_autoplay_buttons" width="4%" padding="0px" href="javascript:void(0)" src="images/c.png" id="product_rotate_antirotate"><img class="product_rotate_buttons buttons_view_minimised product_rotate_autoplay_buttons" width="4%" padding="0px" href="javascript:void(0)" src="images/p.png" id="product_rotate_pause"><img class="product_rotate_buttons buttons_view_minimised product_rotate_autoplay_buttons" width="4%" padding="0px" href="javascript:void(0)" src="images/a.png" id="product_rotate_rotate">');               
            }
            //function created by CG
            $("#product_rotate_zoomin").unbind().click(function(){
            ...
            //function created by CG
            $("#product_rotate_zoomout").unbind().click(function(){
                if(!product_rotate_ontransformation)
                {
                     $('#product_rotate_image').trigger("stop");
                    valore = parseInt($slider.slider('value'), 10) - 12.5;
            ...
            //function created by CG
            $("#product_rotate_pause").unbind().click(function(){
                if(!product_rotate_ontransformation)
                {
                    $('#product_rotate_image').trigger("stop");
                    // $("#product_interactivity_audio").trigger("pause");
            ...
            //function created by CG
            $("#product_rotate_rotate").unbind().click(function(){
                if(!product_rotate_ontransformation)
                {
                    $('#product_rotate_image').trigger('play');
                    howler_audio.pause();
                }
            });

            //function created by CG
            $("#product_rotate_antirotate").unbind().click(function(){
                if(!product_rotate_ontransformation)
                {
                    $('#product_rotate_image').trigger('play');
                    $('#product_rotate_image').data("backwards", true);
                    howler_audio.pause();
                }
            });
            //<-- FBZoom
            ...
            css(___+dot(cached_klass), { display: _none_ });
                  ...
                  */
                  ...
                  /*setTimeout(function(){
                    ...
                    var
                      balastop= opt.balastop,
                      speed= set(_speed_, speed || get(_speed_)),
                      duration= opt.duration,
                      backwards= set(_backwards_, speed < 0),
                      playing= set(_playing_, !!speed),
                      stopped= set(_stopped_, !playing)
                      // audio_url = opt.product_howler_audio_url_reel,
                      // audio_loop = opt.product_howler_audio_loop_reel
                   
                    // alert("url_reel:"+audio_url);
                    // alert("loop_reel:"+audio_loop);
                    ...
                    // }
                    // });
                    $("#interactivity_0").click(function(){
                        howler_audio.stop();
                    });
                    $("#interactivity_1").click(function(){
                        howler_audio.play();
                    });
                    $("#interactivity_2").click(function(){
                        howler_audio.stop();
                    });
                  ...
                  clearTimeout(timerr);
                  //$('#tractor_href_1').show();
                  $("#tractor_href_1").css('visibility', 'visible');
                    ...
                    if (opt.draggable)
                    {
                     ...
                     var
                      ...
                      else
                      {
                        ...
                        // Start - Here we are setting the previous/last left and top position of the element(i.e., the current image used for panning)- Bala
                        
                        //$('#product_rotate_image-reel').css({width: 2592 + 'px', height: 1728 + 'px', overflow: "hidden"}); 
                        
                        newTop = Math.round(- t.position().top + ev.clientY); 
                        newLeft = Math.round(- t.position().left + ev.clientX); 
                        bool = true;    
                        
                        // End - Here we are setting the previous/last left and top position of the element(current image used for panning)- Bala
                    
                    }
                    function drag(e){ return t.trigger('pan', [e.pageX, e.pageY, e]) && e.give }
                  ...
                  //
                  // [1]:httpss://github.com/pisi/Reel/issues/51
                  //
                  
                  // code changed by CG to implement cross and to set 360 rotation horizontally and vertically
                  pan: function(e, x, y, ev)
                  {
                    if (opt.draggable && slidable && opt.cross)
                    {
                      slidable= false;
                      unidle();
                      var
                      ...
                      if (abs(delta.x) > abs(delta.y)){
                        ...
                        if(fraction>0.5)
                            fraction= set(_fraction_,fraction-0.5);
                      ...
                      if (abs(delta.x) < abs(delta.y)){
                        ...
                        var
                          ...
                          origin= get(_clicked_location_),
                          vertical= get(_vertical_),
                          fraction= set(_fraction_, graph(vertical ? x - origin.x : y - origin.y , get(_clicked_on_), revolution, get(_lo_), get(_hi_), get(_cwish_), vertical ? y - origin.y : x - origin.x)),
                          reeling= set(_reeling_, get(_reeling_) || get(_frame_) != get(_clicked_)),
                          motion= to_bias(vertical ? delta.y : delta.x || 0),
                          backwards= motion && set(_backwards_, motion < 0)
                        if(fraction<0.5)
                    ...
                    else if (opt.draggable && slidable)
                    {
                        if(typeof newWidth == 'undefined' || opt.imagewidth == newWidth || newWidth == 0) 
                        {
                          slidable= false;
                          unidle();
                          var
                          ...
                          if (abs(delta.x) > 0 || abs(delta.y) > 0)
                          {
                            ...
                            if (rows > 1) var
                              ...
                              if(tier==1)
                              set(_clicked_tier_,0)
                              else if(tier==0)
                              set(_clicked_tier_,1)
                        ...
                        if(opt.imagewidth < newWidth) 
                        {
                            //$('.fb3dwrap').css({width: 2592 + 'px', height: 1728 + 'px', overflow: hidden}); 
                            //$('#product_rotate_image-reel').css({width: 2592 + 'px', height: 1728 + 'px', overflow: hidden}); 
                            
                            //Start - New code for image panning. Here during mousemove(drag functionality) we are continuously/repeatedly calculating and changing the values of math1(top position) and math2(left position) of element(i.e., the current image used for panning) - Bala
                            
                            if(bool) 
                            { 
                                /*math1 = Math.round(Math.sqrt(Math.pow(newTop - ev.clientY, 2))); 
                                math2 = Math.round(Math.sqrt(Math.pow(newLeft - ev.clientX, 2))); */
                                
                                math1 = Math.round(newTop - ev.clientY); 
                                math2 = Math.round(newLeft - ev.clientX);
                                
                                t.css({top: -math1 + 'px', left: -math2 + 'px'}); 
                            } 
                            
                            //End - New code for image panning. Here during mousemove(drag functionality) we are continuously/repeatedly calculating and changing the values of math1(top position) and math2(left position) of element(i.e., the current image used for panning) - Bala
                            
                            //Old code for image panning- Start
                            ...
                            leftPan = Math.floor(Math.sqrt(Math.pow(ev.pageX - (dOs.left+(igW/2)), 2)));
                            topPan = Math.floor(Math.sqrt(Math.pow(ev.pageY - (dOs.top+(igH/2)), 2)));

                            t.css({left: leftPan, top: topPan});*/  

                            //Old code for image panning - End                         
                  ...
                  //
                  // [1]:httpss://github.com/brandonaaron/jquery-mousewheel
                  // [2]:https://blog.threedubmedia.com/2008/08/eventspecialwheel.html
                  //
                  /*--> FBZoom
                  ...
                  fractionChange: function(e, set_fraction, fraction){
                    if (set_fraction !== undefined) return deprecated(set(_fraction_, set_fraction));
                        ...
                        $("#product_rotate_leftframe").unbind().click(function(){
                            if(!product_rotate_ontransformation)
                            {
                                fraction-=1/opt.frames;                     
                                if(opt.cross && fraction<0)
                                {   
                                    /*if(fraction > 0.5)
                                        fraction-=0.5;*/
                                        fraction+=0.5; 
                                ...
                                //console.log(opt.frames+' '+fraction);
                                unidle();
                                return deprecated(set(_fraction_, fraction));
                            }
                        });
                        
                        //function created by CG
                        $("#product_rotate_rightframe").unbind().click(function(){
                            if(!product_rotate_ontransformation)
                            {
                                fraction+=1/opt.frames;
                                if(opt.cross)
                  ...
                  rowChange: function(e, set_row, row){
                    ...
                    var tier= 1 / (opt.rows - 1) * (row - 1);
                    set(_tier_, tier);
                        
                        //function created by CG
                        $("#product_rotate_upframe").unbind().click(function(){
                            if(!product_rotate_ontransformation)
                            {
                                if(opt.cross)
                                {
                        ...
                        */
                        ...
                        //function created by CG
                        $("#product_rotate_downframe").unbind().click(function(){
                            if(!product_rotate_ontransformation)
                            {
                                if(opt.cross)
                                {
      ...
      //
      // [1]:httpss://github.com/pisi/Reel/wiki/CDN
      //
      ...
      preload: {
        ...
        //
        // ![Example](httpss://camo.githubapp.com/74b73060a50f3cbaf522ec31530d34e3fa5cbcb9/687474703a2f2f6a71756572792e766f737472656c2e637a2f7265656c2f7363617474657265642e6c6f6164696e672e676966)
        //
  ...
  function deprecated(input){ try{ console.warn(/*'Deprecation - Please consult httpss://github.com/pisi/Reel/wiki/Deprecations'*/) }catch(e){} return input }
