		...
		var bool = false;
		 ...
		 var
		  ...
		  setup: function(e)
		  {
				...
				if(typeof(jQuery.event.special.mousewheel) !== 'undefined') 
				{
					t.parent().mousewheel(function(event, delta) 
					{
					 $('#product_rotate_image').trigger("stop");
						if (delta > 0) 
						{
							valore = parseInt($slider.slider('value'), 10) + 25;
			...
			//$('#zoom').html('<img class="product_rotate_buttons product_rotate_zoom_buttons" href="javascript:void(0)" src="http://www.3dwebcommerce.com/3DShop/image/reel/+.png" id="product_rotate_zoomin"><img class="product_rotate_buttons product_rotate_zoom_buttons" href="javascript:void(0)" src="http://www.3dwebcommerce.com/3DShop/image/reel/-.png" id="product_rotate_zoomout"><img class="product_rotate_buttons product_rotate_horizontal_interact_buttons" href="javascript:void(0)" src="http://www.3dwebcommerce.com/3DShop/image/reel/l.png" id="product_rotate_leftframe"><img class="product_rotate_buttons product_rotate_horizontal_interact_buttons" href="javascript:void(0)" src="http://www.3dwebcommerce.com/3DShop/image/reel/r.png" id="product_rotate_rightframe"><img class="product_rotate_buttons product_rotate_vertical_interact_buttons" href="javascript:void(0)" src="http://www.3dwebcommerce.com/3DShop/image/reel/u.png" id="product_rotate_upframe"><img class="product_rotate_buttons product_rotate_vertical_interact_buttons" href="javascript:void(0)" src="http://www.3dwebcommerce.com/3DShop/image/reel/d.png" id="product_rotate_downframe"><img class="product_rotate_buttons product_rotate_autoplay_buttons" href="javascript:void(0)" src="http://www.3dwebcommerce.com/3DShop/image/reel/c.png" id="product_rotate_antirotate"><img class="product_rotate_buttons product_rotate_autoplay_buttons" href="javascript:void(0)" src="http://www.3dwebcommerce.com/3DShop/image/reel/p.png" id="product_rotate_pause"><img class="product_rotate_buttons product_rotate_autoplay_buttons" href="javascript:void(0)" src="http://www.3dwebcommerce.com/3DShop/image/reel/a.png" id="product_rotate_rotate">');
			$('#zoom').html('<img class="product_rotate_buttons product_rotate_zoom_buttons" href="javascript:void(0)" src="http://www.3dwebcommerce.com/3DShop/image/reel/+.png" id="product_rotate_zoomin"><img class="product_rotate_buttons product_rotate_zoom_buttons" href="javascript:void(0)" src="http://www.3dwebcommerce.com/3DShop/image/reel/-.png" id="product_rotate_zoomout"><img class="product_rotate_buttons product_rotate_horizontal_interact_buttons" href="javascript:void(0)" src="http://www.3dwebcommerce.com/3DShop/image/reel/l.png" id="product_rotate_leftframe"><img class="product_rotate_buttons product_rotate_horizontal_interact_buttons" href="javascript:void(0)" src="http://www.3dwebcommerce.com/3DShop/image/reel/r.png" id="product_rotate_rightframe"><img class="product_rotate_buttons product_rotate_autoplay_buttons" href="javascript:void(0)" src="http://www.3dwebcommerce.com/3DShop/image/reel/c.png" id="product_rotate_antirotate"><img class="product_rotate_buttons product_rotate_autoplay_buttons" href="javascript:void(0)" src="http://www.3dwebcommerce.com/3DShop/image/reel/p.png" id="product_rotate_pause"><img class="product_rotate_buttons product_rotate_autoplay_buttons" href="javascript:void(0)" src="http://www.3dwebcommerce.com/3DShop/image/reel/a.png" id="product_rotate_rotate">');				
